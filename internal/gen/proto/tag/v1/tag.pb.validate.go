...
// Validate checks the field values on ListTagsRequest_Sort with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *ListTagsRequest_Sort) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on ListTagsRequest_Sort with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// ListTagsRequest_SortMultiError, or nil if none found.
func (m *ListTagsRequest_Sort) ValidateAll() error {
	return m.validate(true)
}

func (m *ListTagsRequest_Sort) validate(all bool) error {
	if m == nil {
		return nil
	}
...
// ListTagsRequest_SortMultiError is an error wrapping multiple validation
// errors returned by ListTagsRequest_Sort.ValidateAll() if the designated
// constraints aren't met.
type ListTagsRequest_SortMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m ListTagsRequest_SortMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m ListTagsRequest_SortMultiError) AllErrors() []error { return m }

// ListTagsRequest_SortValidationError is the validation error returned by
// ListTagsRequest_Sort.Validate if the designated constraints aren't met.
type ListTagsRequest_SortValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e ListTagsRequest_SortValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e ListTagsRequest_SortValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e ListTagsRequest_SortValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e ListTagsRequest_SortValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e ListTagsRequest_SortValidationError) ErrorName() string {
	return "ListTagsRequest_SortValidationError"
}

// Error satisfies the builtin error interface
func (e ListTagsRequest_SortValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sListTagsRequest_Sort.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = ListTagsRequest_SortValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = ListTagsRequest_SortValidationError{}
