...
func (x *PackageStage) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PackageStage) ProtoMessage() {}

func (x *PackageStage) ProtoReflect() protoreflect.Message {
	mi := &file_package_v1_package_proto_msgTypes[0]
...
// Deprecated: Use PackageStage.ProtoReflect.Descriptor instead.
func (*PackageStage) Descriptor() ([]byte, []int) {
	return file_package_v1_package_proto_rawDescGZIP(), []int{0}
}

func (x *PackageStage) GetId() int32 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *PackageStage) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
type Package struct {
	...
	Stages       []*PackageStage        `protobuf:"bytes,6,rep,name=stages,proto3" json:"stages,omitempty"`
...
func (x *Package) GetStages() []*PackageStage {
	if x != nil {
		return x.Stages
	}
	return nil
...
func (x *PackageStats) GetStageCount() int32 {
	if x != nil {
		return x.StageCount
	}
	return 0
...
var file_package_v1_package_proto_rawDesc = []byte{
	...
	0x22, 0x32, 0x0a, 0x0c, 0x50, 0x61, 0x63, 0x6b, 0x61, 0x67, 0x65, 0x53, 0x74, 0x61, 0x67, 0x65,
	...
	0x73, 0x74, 0x61, 0x67, 0x65, 0x73, 0x18, 0x06, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x70,
	0x61, 0x63, 0x6b, 0x61, 0x67, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x50, 0x61, 0x63, 0x6b, 0x61, 0x67,
	0x65, 0x53, 0x74, 0x61, 0x67, 0x65, 0x52, 0x06, 0x73, 0x74, 0x61, 0x67, 0x65, 0x73, 0x12, 0x12,
	...
	0x73, 0x12, 0x1f, 0x0a, 0x0b, 0x73, 0x74, 0x61, 0x67, 0x65, 0x5f, 0x63, 0x6f, 0x75, 0x6e, 0x74,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0a, 0x73, 0x74, 0x61, 0x67, 0x65, 0x43, 0x6f, 0x75,
...
var file_package_v1_package_proto_goTypes = []interface{}{
	(*PackageStage)(nil),           // 0: package.v1.PackageStage
...
var file_package_v1_package_proto_depIdxs = []int32{
	0,  // 0: package.v1.Package.stages:type_name -> package.v1.PackageStage
