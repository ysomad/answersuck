...
const (
	...
	EmailServiceName = "user.email.v1.EmailService"
)

// EmailServiceClient is a client for the user.email.v1.EmailService service.
...
// NewEmailServiceClient constructs a client for the user.email.v1.EmailService service. By default,
...
// VerifyEmail calls user.email.v1.EmailService.VerifyEmail.
...
// UpdateEmail calls user.email.v1.EmailService.UpdateEmail.
...
// SendVerification calls user.email.v1.EmailService.SendVerification.
...
// EmailServiceHandler is an implementation of the user.email.v1.EmailService service.
...
func NewEmailServiceHandler(svc EmailServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle("/user.email.v1.EmailService/VerifyEmail", connect_go.NewUnaryHandler(
		"/user.email.v1.EmailService/VerifyEmail",
		svc.VerifyEmail,
		opts...,
	))
	mux.Handle("/user.email.v1.EmailService/UpdateEmail", connect_go.NewUnaryHandler(
		"/user.email.v1.EmailService/UpdateEmail",
		svc.UpdateEmail,
		opts...,
	))
	mux.Handle("/user.email.v1.EmailService/SendVerification", connect_go.NewUnaryHandler(
		"/user.email.v1.EmailService/SendVerification",
		svc.SendVerification,
		opts...,
	))
	return "/user.email.v1.EmailService/", mux
}
...
func (UnimplementedEmailServiceHandler) VerifyEmail(context.Context, *connect_go.Request[v1.VerifyEmailRequest]) (*connect_go.Response[v1.VerifyEmailResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("user.email.v1.EmailService.VerifyEmail is not implemented"))
}
...
func (UnimplementedEmailServiceHandler) UpdateEmail(context.Context, *connect_go.Request[v1.UpdateEmailRequest]) (*connect_go.Response[v1.UpdateEmailResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("user.email.v1.EmailService.UpdateEmail is not implemented"))
}
...
func (UnimplementedEmailServiceHandler) SendVerification(context.Context, *connect_go.Request[v1.SendVerificationRequest]) (*connect_go.Response[v1.SendVerificationResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("user.email.v1.EmailService.SendVerification is not implemented"))
}
