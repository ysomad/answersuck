...
const (
	...
	PasswordServiceName = "user.password.v1.PasswordService"
)

// PasswordServiceClient is a client for the user.password.v1.PasswordService service.
...
// NewPasswordServiceClient constructs a client for the user.password.v1.PasswordService service. By
...
// ResetPassword calls user.password.v1.PasswordService.ResetPassword.
...
// SetPassword calls user.password.v1.PasswordService.SetPassword.
...
// UpdatePassword calls user.password.v1.PasswordService.UpdatePassword.
...
// PasswordServiceHandler is an implementation of the user.password.v1.PasswordService service.
...
func NewPasswordServiceHandler(svc PasswordServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle("/user.password.v1.PasswordService/ResetPassword", connect_go.NewUnaryHandler(
		"/user.password.v1.PasswordService/ResetPassword",
		svc.ResetPassword,
		opts...,
	))
	mux.Handle("/user.password.v1.PasswordService/SetPassword", connect_go.NewUnaryHandler(
		"/user.password.v1.PasswordService/SetPassword",
		svc.SetPassword,
		opts...,
	))
	mux.Handle("/user.password.v1.PasswordService/UpdatePassword", connect_go.NewUnaryHandler(
		"/user.password.v1.PasswordService/UpdatePassword",
		svc.UpdatePassword,
		opts...,
	))
	return "/user.password.v1.PasswordService/", mux
}
...
func (UnimplementedPasswordServiceHandler) ResetPassword(context.Context, *connect_go.Request[v1.ResetPasswordRequest]) (*connect_go.Response[v1.ResetPasswordResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("user.password.v1.PasswordService.ResetPassword is not implemented"))
}
...
func (UnimplementedPasswordServiceHandler) SetPassword(context.Context, *connect_go.Request[v1.SetPasswordRequest]) (*connect_go.Response[v1.SetPasswordResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("user.password.v1.PasswordService.SetPassword is not implemented"))
}
...
func (UnimplementedPasswordServiceHandler) UpdatePassword(context.Context, *connect_go.Request[v1.UpdatePasswordRequest]) (*connect_go.Response[v1.UpdatePasswordResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("user.password.v1.PasswordService.UpdatePassword is not implemented"))
}
