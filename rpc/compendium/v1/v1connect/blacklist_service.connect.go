...
import (
	...
	v1 "github.com/ysomad/answersuck/rpc/compendium/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	BlackListServiceName = "compendium.v1.BlackListService"
)

// BlackListServiceClient is a client for the compendium.v1.BlackListService service.
...
// NewBlackListServiceClient constructs a client for the compendium.v1.BlackListService service. By
...
func NewBlackListServiceClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) BlackListServiceClient {
	...
	return &blackListServiceClient{
		findBannedWord: connect_go.NewClient[v1.FindBannedWordRequest, v1.FindBannedWordResponse](
			httpClient,
			baseURL+"/compendium.v1.BlackListService/FindBannedWord",
			opts...,
		),
	}
}
...
// FindBannedWord calls compendium.v1.BlackListService.FindBannedWord.
...
// BlackListServiceHandler is an implementation of the compendium.v1.BlackListService service.
...
func NewBlackListServiceHandler(svc BlackListServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle("/compendium.v1.BlackListService/FindBannedWord", connect_go.NewUnaryHandler(
		"/compendium.v1.BlackListService/FindBannedWord",
		svc.FindBannedWord,
		opts...,
	))
	return "/compendium.v1.BlackListService/", mux
}
...
func (UnimplementedBlackListServiceHandler) FindBannedWord(context.Context, *connect_go.Request[v1.FindBannedWordRequest]) (*connect_go.Response[v1.FindBannedWordResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("compendium.v1.BlackListService.FindBannedWord is not implemented"))
}
